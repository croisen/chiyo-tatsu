...
class BackupCategory final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:BackupCategory) */ {
 public:
  inline BackupCategory() : BackupCategory(nullptr) {}
  ~BackupCategory() override;
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR BackupCategory(
      ::google::protobuf::internal::ConstantInitialized);

  inline BackupCategory(const BackupCategory& from) : BackupCategory(nullptr, from) {}
  inline BackupCategory(BackupCategory&& from) noexcept
      : BackupCategory(nullptr, std::move(from)) {}
  ...
  friend void swap(BackupCategory& a, BackupCategory& b) { a.Swap(&b); }
  ...
  BackupCategory* New(::google::protobuf::Arena* arena = nullptr) const final {
    return ::google::protobuf::Message::DefaultConstruct<BackupCategory>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const BackupCategory& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const BackupCategory& from) { BackupCategory::MergeImpl(*this, from); }
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "BackupCategory"; }

 protected:
  explicit BackupCategory(::google::protobuf::Arena* arena);
  BackupCategory(::google::protobuf::Arena* arena, const BackupCategory& from);
  BackupCategory(::google::protobuf::Arena* arena, BackupCategory&& from) noexcept
      : BackupCategory(arena) {
    *this = ::std::move(from);
  }
