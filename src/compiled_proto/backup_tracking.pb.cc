...
const ::uint32_t
    TableStruct_backup_5ftracking_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_backup_5ftracking_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_backup_5ftracking_2eproto = {
    false,
    false,
    294,
...
inline PROTOBUF_NDEBUG_INLINE BackupTracking::Impl_::Impl_(
    ...
    const Impl_& from, const ::BackupTracking& from_msg)
...
BackupTracking::GetClassData() const {
      ...
      ClassDataFull _data_ = {
          {
              ...
              PROTOBUF_FIELD_OFFSET(BackupTracking, _impl_._cached_size_),
              false,
          },
          &BackupTracking::MergeImpl,
          &BackupTracking::kDescriptorMethods,
...
const ::_pbi::TcParseTable<4, 12, 0, 47, 7> BackupTracking::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::BackupTracking>(),  // to_prefetch
...
::uint8_t* BackupTracking::_InternalSerialize(
  ...
  // float lastChapterRead = 6;
  if (::absl::bit_cast<::uint32_t>(this->_internal_lastchapterread()) != 0) {
  ...
  // float score = 8;
  if (::absl::bit_cast<::uint32_t>(this->_internal_score()) != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(
...
void BackupTracking::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  if (from._internal_syncid() != 0) {
    _this->_impl_.syncid_ = from._impl_.syncid_;
  }
  if (from._internal_mediaidint() != 0) {
    _this->_impl_.mediaidint_ = from._impl_.mediaidint_;
  }
  if (::absl::bit_cast<::uint32_t>(from._internal_lastchapterread()) != 0) {
    _this->_impl_.lastchapterread_ = from._impl_.lastchapterread_;
  }
  if (from._internal_totalchapters() != 0) {
    _this->_impl_.totalchapters_ = from._impl_.totalchapters_;
  }
  ...
  if (from._internal_startedreadingdate() != 0) {
    _this->_impl_.startedreadingdate_ = from._impl_.startedreadingdate_;
  }
  if (from._internal_finishedreadingdate() != 0) {
    _this->_impl_.finishedreadingdate_ = from._impl_.finishedreadingdate_;
  }
  if (from._internal_mediaid() != 0) {
    _this->_impl_.mediaid_ = from._impl_.mediaid_;
  }
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_backup_5ftracking_2eproto),
         ::std::false_type{});
