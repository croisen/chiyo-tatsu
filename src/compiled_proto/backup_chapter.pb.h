...
class BackupChapter final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:BackupChapter) */ {
 public:
  inline BackupChapter() : BackupChapter(nullptr) {}
  ~BackupChapter() override;
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR BackupChapter(
      ::google::protobuf::internal::ConstantInitialized);

  inline BackupChapter(const BackupChapter& from) : BackupChapter(nullptr, from) {}
  inline BackupChapter(BackupChapter&& from) noexcept
      : BackupChapter(nullptr, std::move(from)) {}
  ...
  friend void swap(BackupChapter& a, BackupChapter& b) { a.Swap(&b); }
  ...
  BackupChapter* New(::google::protobuf::Arena* arena = nullptr) const final {
    return ::google::protobuf::Message::DefaultConstruct<BackupChapter>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const BackupChapter& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const BackupChapter& from) { BackupChapter::MergeImpl(*this, from); }
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "BackupChapter"; }

 protected:
  explicit BackupChapter(::google::protobuf::Arena* arena);
  BackupChapter(::google::protobuf::Arena* arena, const BackupChapter& from);
  BackupChapter(::google::protobuf::Arena* arena, BackupChapter&& from) noexcept
      : BackupChapter(arena) {
    *this = ::std::move(from);
  }
