...
class BackupTracking final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:BackupTracking) */ {
 public:
  inline BackupTracking() : BackupTracking(nullptr) {}
  ~BackupTracking() override;
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR BackupTracking(
      ::google::protobuf::internal::ConstantInitialized);

  inline BackupTracking(const BackupTracking& from) : BackupTracking(nullptr, from) {}
  inline BackupTracking(BackupTracking&& from) noexcept
      : BackupTracking(nullptr, std::move(from)) {}
  ...
  friend void swap(BackupTracking& a, BackupTracking& b) { a.Swap(&b); }
  ...
  BackupTracking* New(::google::protobuf::Arena* arena = nullptr) const final {
    return ::google::protobuf::Message::DefaultConstruct<BackupTracking>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const BackupTracking& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const BackupTracking& from) { BackupTracking::MergeImpl(*this, from); }
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "BackupTracking"; }

 protected:
  explicit BackupTracking(::google::protobuf::Arena* arena);
  BackupTracking(::google::protobuf::Arena* arena, const BackupTracking& from);
  BackupTracking(::google::protobuf::Arena* arena, BackupTracking&& from) noexcept
      : BackupTracking(arena) {
    *this = ::std::move(from);
  }
