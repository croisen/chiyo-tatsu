...
static ::_pb::Metadata file_level_metadata_backup_5fmanga_2eproto[1];
...
const ::uint32_t TableStruct_backup_5fmanga_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
...
const char descriptor_table_protodef_backup_5fmanga_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\022backup_manga.proto\032\024backup_chapter.pro"
    "to\032\024backup_history.proto\032\025backup_trackin"
    "g.proto\032\033manga_update_strategy.proto\"\231\006\n"
    ...
    "\022\020\n\010favorite\030d \001(\010\022\024\n\014chapterFlags\030e \001(\005"
    "\022+\n\rbrokenHistory\030f \003(\0132\024.BrokenBackupHi"
    "story\022\031\n\014viewer_flags\030g \001(\005H\010\210\001\001\022\037\n\007hist"
    "ory\030h \003(\0132\016.BackupHistory\022\'\n\016updateStrat"
    "egy\030i \001(\0162\017.UpdateStrategy\022\026\n\016lastModifi"
    "edAt\030j \001(\003\022\037\n\022favoriteModifiedAt\030k \001(\003H\t"
    "\210\001\001B\t\n\007_artistB\t\n\007_authorB\016\n\014_descriptio"
    "nB\017\n\r_thumbnailUrlB\016\n\014_customCoverB\r\n\013_l"
    "astUpdateB\013\n\t_lastInitB\010\n\006_flagsB\017\n\r_vie"
...
const ::_pbi::DescriptorTable descriptor_table_backup_5fmanga_2eproto = {
    false,
    false,
    920,
    ...
    file_level_metadata_backup_5fmanga_2eproto,
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_backup_5fmanga_2eproto_getter() {
  return &descriptor_table_backup_5fmanga_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_backup_5fmanga_2eproto(&descriptor_table_backup_5fmanga_2eproto);
// ===================================================================

class BackupManga::_Internal {
 public:
  using HasBits = decltype(std::declval<BackupManga>()._impl_._has_bits_);
  ...
  static void set_has_customcover(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
  static void set_has_lastupdate(HasBits* has_bits) {
    (*has_bits)[0] |= 32u;
  }
  static void set_has_lastinit(HasBits* has_bits) {
    (*has_bits)[0] |= 64u;
  }
  static void set_has_flags(HasBits* has_bits) {
    (*has_bits)[0] |= 128u;
  }
  static void set_has_viewer_flags(HasBits* has_bits) {
    (*has_bits)[0] |= 256u;
  }
  static void set_has_favoritemodifiedat(HasBits* has_bits) {
    (*has_bits)[0] |= 512u;
  }
};
...
// @@protoc_insertion_point(message_clear_start:BackupManga)
  ...
  ::memset(&_impl_.favorite_, 0, static_cast<::size_t>(
      reinterpret_cast<char*>(&_impl_.chapterflags_) -
      reinterpret_cast<char*>(&_impl_.favorite_)) + sizeof(_impl_.chapterflags_));
...
const char* BackupManga::_InternalParse(
...
const ::_pbi::TcParseTable<5, 26, 4, 103, 7> BackupManga::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastV8S2,
     {1696, 63, 0, PROTOBUF_FIELD_OFFSET(BackupManga, _impl_.favorite_)}},
    // int32 chapterFlags = 101;
    {::_pbi::TcParser::FastV32S2,
     {1704, 63, 0, PROTOBUF_FIELD_OFFSET(BackupManga, _impl_.chapterflags_)}},
    ...
    {::_pbi::TcParser::FastV32S2,
     {1720, 8, 0, PROTOBUF_FIELD_OFFSET(BackupManga, _impl_.viewer_flags_)}},
    ...
    {::_pbi::TcParser::FastV64S2,
     {1752, 9, 0, PROTOBUF_FIELD_OFFSET(BackupManga, _impl_.favoritemodifiedat_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
    ...
    (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
    // bool favorite = 100;
    {PROTOBUF_FIELD_OFFSET(BackupManga, _impl_.favorite_), -1, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kBool)},
    // int32 chapterFlags = 101;
    {PROTOBUF_FIELD_OFFSET(BackupManga, _impl_.chapterflags_), -1, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt32)},
    // repeated .BrokenBackupHistory brokenHistory = 102;
    {PROTOBUF_FIELD_OFFSET(BackupManga, _impl_.brokenhistory_), -1, 2,
    (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
    // optional int32 viewer_flags = 103;
    {PROTOBUF_FIELD_OFFSET(BackupManga, _impl_.viewer_flags_), _Internal::kHasBitsOffset + 8, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // repeated .BackupHistory history = 104;
    ...
    (0 | ::_fl::kFcSingular | ::_fl::kInt64)},
    // optional int64 favoriteModifiedAt = 107;
    {PROTOBUF_FIELD_OFFSET(BackupManga, _impl_.favoritemodifiedat_), _Internal::kHasBitsOffset + 9, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
  }}, {{
...
::uint8_t* BackupManga::_InternalSerialize(
  ...
  // repeated .BackupChapter chapters = 16;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_chapters_size()); i < n; i++) {
  ...
  // repeated .BackupTracking tracking = 18;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_tracking_size()); i < n; i++) {
  ...
  // int32 chapterFlags = 101;
  if (this->_internal_chapterflags() != 0) {
    target = stream->EnsureSpace(target);
  ...
  // repeated .BrokenBackupHistory brokenHistory = 102;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_brokenhistory_size()); i < n; i++) {
...
const ::google::protobuf::Message::ClassData BackupManga::_class_data_ = {
    BackupManga::MergeImpl,
    nullptr,  // OnDemandRegisterArenaDtor
};
const ::google::protobuf::Message::ClassData* BackupManga::GetClassData() const {
  return &_class_data_;
}

void BackupManga::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  if (from._internal_viewer() != 0) {
    _this->_internal_set_viewer(from._internal_viewer());
  }
  if (cached_has_bits & 0x00000040u) {
    _this->_internal_set_lastinit(from._internal_lastinit());
  }
  if (from._internal_dateadded() != 0) {
    _this->_internal_set_dateadded(from._internal_dateadded());
  }
  if (cached_has_bits & 0x00000080u) {
    _this->_internal_set_flags(from._internal_flags());
  }
  if (from._internal_favorite() != 0) {
    _this->_internal_set_favorite(from._internal_favorite());
  }
  if (from._internal_chapterflags() != 0) {
    _this->_internal_set_chapterflags(from._internal_chapterflags());
  }
  if (cached_has_bits & 0x00000100u) {
    _this->_internal_set_viewer_flags(from._internal_viewer_flags());
  }
  if (from._internal_lastmodifiedat() != 0) {
    _this->_internal_set_lastmodifiedat(from._internal_lastmodifiedat());
  }
  if (cached_has_bits & 0x00000200u) {
    _this->_internal_set_favoritemodifiedat(from._internal_favoritemodifiedat());
  }
  if (from._internal_updatestrategy() != 0) {
    _this->_internal_set_updatestrategy(from._internal_updatestrategy());
  }
...
PROTOBUF_NOINLINE bool BackupManga::IsInitialized() const {
  return true;
}

::_pbi::CachedSize* BackupManga::AccessCachedSize() const {
...
::google::protobuf::Metadata BackupManga::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_backup_5fmanga_2eproto_getter, &descriptor_table_backup_5fmanga_2eproto_once,
      file_level_metadata_backup_5fmanga_2eproto[0]);
}
