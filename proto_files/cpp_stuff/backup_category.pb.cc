...
const char descriptor_table_protodef_backup_5fcategory_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\025backup_category.proto\"<\n\016BackupCategor"
    "y\022\014\n\004name\030\001 \001(\t\022\r\n\005order\030\002 \001(\005\022\r\n\005flags\030"
    "d \001(\005b\006proto3"
};
...
// @@protoc_insertion_point(message_clear_start:BackupCategory)
  ...
  ::memset(&_impl_.order_, 0, static_cast<::size_t>(
      ...
      reinterpret_cast<char*>(&_impl_.order_)) + sizeof(_impl_.flags_));
...
const ::_pbi::TcParseTable<2, 3, 0, 27, 7> BackupCategory::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    // string name = 1;
    {PROTOBUF_FIELD_OFFSET(BackupCategory, _impl_.name_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // int32 order = 2;
    {PROTOBUF_FIELD_OFFSET(BackupCategory, _impl_.order_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt32)},
    // int32 flags = 100;
    {PROTOBUF_FIELD_OFFSET(BackupCategory, _impl_.flags_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt32)},
  }},
  // no aux_entries
  {{
